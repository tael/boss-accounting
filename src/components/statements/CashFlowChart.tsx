...
export default function CashFlowChart() {
  ...
  const formatTooltipValue = (value: number) => formatKRW(value)

  return (
    <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
      <h2 className="text-base font-semibold text-gray-800 mb-4">월별 현금흐름 (최근 12개월)</h2>
